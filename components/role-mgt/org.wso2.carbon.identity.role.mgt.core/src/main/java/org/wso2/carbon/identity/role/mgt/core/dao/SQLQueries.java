...
public class SQLQueries {
    ...
    public static final String DELETE_ROLE_WITH_AUDIENCE_SQL = "DELETE FROM UM_HYBRID_ROLE WHERE " +
    ...
    public static final String UPDATE_HYBRID_ROLE_UUID_WITH_AUDIENCE_SQL = "UPDATE UM_HYBRID_ROLE SET " +
            "UM_UUID=:UM_UUID; WHERE UM_ROLE_NAME=:UM_ROLE_NAME; AND UM_TENANT_ID=:UM_TENANT_ID; " +
            "AND UM_AUDIENCE_REF_ID=-1";
    ...
    public static final String REMOVE_USER_FROM_ROLE_WITH_AUDIENCE_SQL =
            "DELETE FROM UM_HYBRID_USER_ROLE WHERE UM_USER_NAME=:UM_USER_NAME; AND "
                    + "UM_ROLE_ID=(SELECT UM_ID FROM UM_HYBRID_ROLE WHERE UM_ROLE_NAME=:UM_ROLE_NAME; AND "
                    + "UM_TENANT_ID=:UM_TENANT_ID; AND UM_AUDIENCE_REF_ID=-1) AND UM_TENANT_ID=:UM_TENANT_ID; " +
                    "AND UM_DOMAIN_ID=(SELECT UM_DOMAIN_ID FROM UM_DOMAIN WHERE UM_TENANT_ID=:UM_TENANT_ID; AND " +
                    "UM_DOMAIN_NAME=:UM_DOMAIN_NAME;)";
    ...
    public static final String ADD_GROUP_TO_ROLE_WITH_AUDIENCE_SQL_MSSQL =
            "INSERT INTO UM_HYBRID_GROUP_ROLE (UM_GROUP_NAME, UM_ROLE_ID, UM_TENANT_ID,  UM_DOMAIN_ID) SELECT " +
                    "(:UM_GROUP_NAME;),(SELECT UM_ID FROM UM_HYBRID_ROLE WHERE UM_ROLE_NAME=:UM_ROLE_NAME; AND " +
                    "UM_TENANT_ID=:UM_TENANT_ID; AND UM_AUDIENCE_REF_ID=-1), (:UM_TENANT_ID;), (SELECT UM_DOMAIN_ID " +
                    "FROM UM_DOMAIN WHERE UM_TENANT_ID=:UM_TENANT_ID; AND UM_DOMAIN_NAME=:UM_DOMAIN_NAME;)";
    ...
    public static final String REMOVE_GROUP_FROM_ROLE_WITH_AUDIENCE_SQL = "DELETE FROM UM_HYBRID_GROUP_ROLE WHERE " +
            "UM_GROUP_NAME=:UM_GROUP_NAME; AND UM_ROLE_ID=(SELECT UM_ID FROM UM_HYBRID_ROLE WHERE " +
            "UM_ROLE_NAME=:UM_ROLE_NAME; AND UM_TENANT_ID=:UM_TENANT_ID; AND UM_AUDIENCE_REF_ID=-1) AND " +
    ...
    public static final String GET_USER_LIST_OF_ROLE_WITH_AUDIENCE_SQL = "SELECT UM_USER_NAME, UM_DOMAIN_NAME FROM " +
    ...
    public static final String GET_GROUP_LIST_OF_ROLE_WITH_AUDIENCE_SQL = "SELECT UM_GROUP_NAME, UM_DOMAIN_NAME FROM " +
    ...
    public static final String GET_ROLES_BY_TENANT_WITH_AUDIENCE_DB2 = "SELECT UM_ROLE_NAME, UM_UUID FROM (SELECT " +
            "ROW_NUMBER() OVER(ORDER BY UM_ID DESC) AS rn,UM_HYBRID_ROLE.* FROM UM_HYBRID_ROLE WHERE " +
    ...
    public static final String GET_ROLES_BY_TENANT_WITH_AUDIENCE_INFORMIX = "SELECT SKIP :OFFSET; FIRST "
            + ":LIMIT; UM_ROLE_NAME, UM_UUID FROM UM_HYBRID_ROLE WHERE UM_TENANT_ID=:UM_TENANT_ID; " +
            "AND UM_AUDIENCE_REF_ID=-1 ORDER BY UM_ID DESC";
    ...
    public static final String GET_ROLES_BY_TENANT_AND_ROLE_NAME_WITH_AUDIENCE_MYSQL = "SELECT UM_ROLE_NAME, UM_UUID " +
            "FROM UM_HYBRID_ROLE WHERE UM_TENANT_ID=:UM_TENANT_ID; AND UM_ROLE_NAME LIKE :UM_ROLE_NAME; AND " +
            "UM_AUDIENCE_REF_ID=-1 ORDER BY UM_ID DESC LIMIT :OFFSET;, :LIMIT;";
    ...
    public static final String GET_ROLES_BY_TENANT_AND_ROLE_NAME_WITH_AUDIENCE_MSSQL =
            "SELECT UM_ROLE_NAME, UM_UUID FROM UM_HYBRID_ROLE WHERE UM_TENANT_ID=:UM_TENANT_ID; AND " +
                    "UM_AUDIENCE_REF_ID=-1 AND UM_ROLE_NAME LIKE :UM_ROLE_NAME; ORDER BY UM_ID DESC OFFSET :OFFSET; " +
    ...
    public static final String GET_ROLES_BY_TENANT_AND_ROLE_NAME_WITH_AUDIENCE_DB2 = "SELECT UM_ROLE_NAME, " +
            "UM_UUID FROM (SELECT ROW_NUMBER() OVER(ORDER BY UM_ID DESC) AS rn,UM_HYBRID_ROLE.* FROM " +
            "UM_HYBRID_ROLE WHERE UM_TENANT_ID=:UM_TENANT_ID; AND UM_AUDIENCE_REF_ID=-1 AND " +
    ...
    public static final String UPDATE_SCIM_ROLE_NAME_WITH_AUDIENCE_SQL =
            "UPDATE IDN_SCIM_GROUP SET ROLE_NAME=:NEW_ROLE_NAME; WHERE TENANT_ID=:TENANT_ID; AND " +
                    "ROLE_NAME=:ROLE_NAME; AND AUDIENCE_REF_ID=-1";
